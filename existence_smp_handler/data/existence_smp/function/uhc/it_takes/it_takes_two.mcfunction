...
execute if score @s[team=!Default] exi_uhc_on_team < @p[tag=exi_uhc_new_team] exi_uhc_on_team run execute as @a[tag=alive,team=!Default] if score @s exi_uhc_team_code = @p[tag=exi_uhc_new_team] exi_uhc_team_code run tag @s add exi_uhc_merge_team
execute if score @s[team=!Default] exi_uhc_on_team > @p[tag=exi_uhc_new_team] exi_uhc_on_team run execute as @a[tag=alive,team=!Default] if score @s exi_uhc_team_code = @p[tag=exi_uhc_found_team] exi_uhc_team_code run tag @s add exi_uhc_merge_team

execute if score @s exi_uhc_on_team matches 2 if score @p[tag=exi_uhc_new_team] exi_uhc_on_team matches 2 as @a[tag=alive,team=!Default] if score @s exi_uhc_team_code = @p[tag=exi_uhc_new_team] exi_uhc_team_code run tag @s add exi_uhc_merge_team
execute if score @s exi_uhc_on_team matches 2 if score @p[tag=exi_uhc_new_team] exi_uhc_on_team matches 2 as @a[tag=alive,team=!Default] if score @s exi_uhc_team_code = @p[tag=exi_uhc_found_team] exi_uhc_team_code run tag @s add exi_uhc_merge_team
execute if score debug exi_uhc matches 1 run tellraw @a ["",{"text":"exi_uhc_merge_team "},{"selector":"@a[tag=exi_uhc_merge_team]"}]
